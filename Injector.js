define (function  (require) {
	...
	var Dictionary = require('shovejs/Dictionary');
	...
	{	
		if (typeof this.injectionPointsByClass.get(clazz) == 'undefined') { this.injectionPointsByClass.set(clazz, {}); }
	...
	{	
		if (typeof this.valueMappingsByClass.get(clazz) == 'undefined') { this.valueMappingsByClass.set(clazz, {}); }
