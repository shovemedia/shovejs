...
/*
	Lee Coltrane - 4/4/2012
	unhandledRejectionHandler
*/
var unhandledRejectionHandler = function(value) {
    if (value instanceof Error)
    {
    	console.error("unhandledRejectionHandler", value.stack);
    }
    else
    {
    	console.warn("warning: rejection reached end of promise chain without being handled", value.toString());
    }
}

exports.setUnhandledRejectionHandler = function(fn) {
    unhandledRejectionHandler = fn || function() {};
}
...
function defer() {
    ...
    function become(resolvedValue) {
		...
		/*
			...
			unhandledRejectionHandler
		*/
    	if( pending.length === 0 && isRejected(value) ) {
    		unhandledRejectionHandler( value.valueOf().reason );
    	}
